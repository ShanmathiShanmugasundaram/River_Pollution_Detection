...
def get_state(file_name):
    ...
    if "uttarakhand" in file_name or "uk_" in file_name:
        return "Uttarakhand"

    elif "uttar pradesh" in file_name or "uttarpradesh" in file_name or "up_" in file_name:
        return "Uttar Pradesh"

    elif "bihar" in file_name or "bh_" in file_name:
        return "Bihar"

    elif "jharkhand" in file_name or "jh_" in file_name:
        return "Jharkhand"

    elif "west_bengal" in file_name or "west bengal" in file_name or "wb_" in file_name:
        return "West Bengal"
...
def main():
    ...
    ph_folder = PROJECT_DIR / "Ganga_Dataset" / "PH"

    all_data = []

    excel_files = sorted(ph_folder.glob("*.xlsx"))
    ...
    output_file = output_folder / "Master_PH.csv"
