...
def get_state(file_name):
    ...
    elif "uttar pradesh" in file_name or "uttarpradesh" in file_name:
    ...
    elif "west_bengal" in file_name or "west bengal" in file_name:
        return "West Bengal"
...
def main():
    ...
    excel_files = sorted(do_folder.glob("*.xlsx"))
    ...
    output_file = output_folder / "Master_DO.csv"
